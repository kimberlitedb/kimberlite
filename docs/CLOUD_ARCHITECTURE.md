...
This document describes the architecture of Kimberlite's cloud platform, which provides managed database services on top of the core Kimberlite engine.

## Overview

The cloud platform consists of two layers:
1. **Core Layer** (`crates/kmb-*`) - The Kimberlite database engine
2. **Platform Layer** (`platform/crates/*`) - Multi-tenant control plane

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                         Kimberlite Cloud Platform                              │
│                                                                              │
│  ┌────────────────────────────────────────────────────────────────────────┐ │
│  │                         Platform Layer                                  │ │
│  │                                                                         │ │
...
Cluster and node management for Kimberlite deployments.
...
- Separate Kimberlite tenants per organization
...
- **Kimberlite**: VSR cluster with automatic failover
...
- **Tenant Data**: Kimberlite checkpoints and exports
...
- [ARCHITECTURE.md](ARCHITECTURE.md) - Core Kimberlite architecture
