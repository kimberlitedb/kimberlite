...
| `no_lost_commits` chaos invariant | ✅ Closed Phase A (Apr 2026) | Real watermark probe: shim tracks acknowledged writes via `GET /state/commit_watermark`; checker asserts max−min ≤ tolerance |
