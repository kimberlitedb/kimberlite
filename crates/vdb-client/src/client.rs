...
use bytes::BytesMut;
use vdb_types::{DataClass, Offset, Placement, StreamId, TenantId};
use vdb_wire::{
...
/// RPC client for `VerityDB`.
///
/// This client uses synchronous I/O to communicate with a `VerityDB` server
