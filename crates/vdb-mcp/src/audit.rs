...
mod tests {
    ...
    fn test_audit_record_builder() {
        ...
        let record = AuditRecord::builder(token_id, tenant_id, "verity_query")
            .table("users")
            .transformation("mask:email")
            .success(42, 150);

        assert_eq!(record.tool_name, "verity_query");
    ...
    fn test_audit_log() {
        ...
        let record = AuditRecord::builder(token_id, tenant_id, "verity_query").success(10, 50);
