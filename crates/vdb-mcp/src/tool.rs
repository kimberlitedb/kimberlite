...
//!
//! Defines the tools available to MCP clients for interacting with `VerityDB`.
...
pub fn query_tool() -> ToolDefinition {
    ToolDefinition {
        name: "verity_query".to_string(),
        description: "Execute a SQL query against VerityDB with automatic access control \
...
pub fn export_tool() -> ToolDefinition {
    ToolDefinition {
        name: "verity_export".to_string(),
        description: "Export data from VerityDB tables with automatic anonymization and \
    ...
    ToolDefinition {
        ...
        input_schema: serde_json::json!({
            ...
            "properties": {
                "export_id": {
                    "type": "string",
                    "description": "The export ID returned from a previous verity_export call."
                },
                "content_hash": {
                    "type": "string",
...
pub fn list_tables_tool() -> ToolDefinition {
    ToolDefinition {
        name: "verity_list_tables".to_string(),
