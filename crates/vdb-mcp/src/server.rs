...
impl McpServer {
    ...
    pub fn with_db_and_tokens(db: Arc<Verity>, tokens: Arc<RwLock<TokenStore>>) -> Self {
...
mod tests {
    ...
    fn test_initialize() {
        ...
        assert_eq!(result["serverInfo"]["name"], "verity-mcp");
    }
    ...
    fn test_list_tools() {
        ...
        // Check that verity_query tool is present
        let has_query = tools.iter().any(|t| t["name"] == "verity_query");
        assert!(has_query);
    }
