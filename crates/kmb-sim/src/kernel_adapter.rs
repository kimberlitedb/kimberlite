...
//!
//! ```ignore
//! use kmb_sim::{SimClock, SimStorage, SimNetwork};
//! use kmb_sim::kernel_adapter::{ClockAdapter, StorageAdapter, NetworkAdapter};
//! use kmb_kernel::Runtime;
//!
...
mod tests {
    ...
    fn storage_adapter_metadata_roundtrip() {
        ...
        let metadata = StreamMetadata::new(
            stream_id,
            kmb_types::StreamName::new("test-stream"),
            DataClass::NonPHI,
            Placement::Global,
        );
