...
impl ScenarioType {
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            Self::GrayFailures => "Partial node failures: slow responses, intermittent errors, read-only nodes",
            Self::MultiTenantIsolation => "Multiple tenants with independent data, testing isolation under faults",
