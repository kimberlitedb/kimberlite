...
//!
//! `VerityDB` uses FIPS-approved algorithms for compliance-critical operations.
...
//!
//! ```
//! use vdb_crypto::hash::{HashPurpose, InternalHash, internal_hash, hash_with_purpose};
//!
...
///
/// ```
/// use vdb_crypto::hash::internal_hash;
///
...
///
/// ```
/// use vdb_crypto::hash::{HashPurpose, HashAlgorithm, hash_with_purpose};
///
