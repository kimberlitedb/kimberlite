//! # kmb-vsr: Viewstamped Replication for `Kimberlite`
//!
//! This crate implements the Viewstamped Replication (VSR) consensus protocol
//! for `Kimberlite`, enabling distributed replication with guaranteed data durability
//! and consistency.
//!
//! ## Overview
//!
...
//!          ▼
//! ┌─────────────────┐
//! │  kmb-kernel     │  Pure state transition, produce Effects
//! └─────────────────┘
//! ```
//!
//! ## Key Components
...
//!
//! ```ignore
//! use kimberlite_vsr::{ClusterConfig, ReplicaId, Superblock, MemorySuperblock};
//!
