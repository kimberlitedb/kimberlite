...
use kimberlite_kernel::{Command, Effect, KernelError, State, apply_committed};
...
///
/// ```ignore
/// use kimberlite_vsr::{SingleNodeReplicator, ClusterConfig, ReplicaId, MemorySuperblock};
/// use kimberlite_kernel::{Command, State};
///
...
mod tests {
    ...
    fn kernel_error_propagates() {
        ...
        let bad_command = Command::append_batch(
            kimberlite_types::StreamId::new(999), // Non-existent
