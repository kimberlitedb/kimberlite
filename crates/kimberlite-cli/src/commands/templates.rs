//! Project scaffolding templates for `kimberlite init --template`.
...
impl Template {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            Self::Healthcare => "HIPAA-ready (patients, encounters, providers)",
...
const HEALTHCARE_SQL: &str = r"-- Healthcare Schema (HIPAA-ready)
-- Generated by: kimberlite init --template healthcare
...
HIPAA-ready database scaffolding for healthcare applications.
...
-- Generated by: kimberlite init --template finance
...
-- Generated by: kimberlite init --template legal
...
-- Generated by: kimberlite init --template multi-tenant
