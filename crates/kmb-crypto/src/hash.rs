...
//!
//! ```
//! use kmb_crypto::hash::{HashPurpose, InternalHash, internal_hash, hash_with_purpose};
//!
...
///
/// ```
/// use kmb_crypto::hash::internal_hash;
///
...
///
/// ```
/// use kmb_crypto::hash::{HashPurpose, HashAlgorithm, hash_with_purpose};
///
