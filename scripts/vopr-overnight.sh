...
# Number of iterations (100k = ~8-12 hours depending on hardware)
ITERATIONS="${VOPR_ITERATIONS:-100000}"
...
generate_summary() {
    ...
    local failure_count
    failure_count=$(grep -c "FAIL" "${LOG_FILE}" 2>/dev/null || echo "0")
